package ru.javaops.restaurant_vote.web.user;
...
import ru.javaops.restaurant_vote.repository.UserRepository;
import ru.javaops.restaurant_vote.to.UserTo;
import ru.javaops.restaurant_vote.util.JsonUtil;
import ru.javaops.restaurant_vote.util.UsersUtil;
...
import static ru.javaops.restaurant_vote.web.user.ProfileController.REST_URL;
import static ru.javaops.restaurant_vote.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
import static ru.javaops.restaurant_vote.web.user.UserTestData.*;
