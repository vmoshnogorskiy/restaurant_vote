...
import ru.javaops.votes.util.UsersUtil;
...
import static ru.javaops.votes.web.user.ProfileController.REST_URL;
import static ru.javaops.votes.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
