...
import ru.javaops.restaurant_vote.service.MealService;
import ru.javaops.restaurant_vote.to.MealTo;
import ru.javaops.restaurant_vote.util.MealsUtil;
import ru.javaops.restaurant_vote.web.AuthUser;
...
import static ru.javaops.restaurant_vote.util.DateTimeUtil.atStartOfDayOrMin;
import static ru.javaops.restaurant_vote.util.DateTimeUtil.atStartOfNextDayOrMax;
import static ru.javaops.restaurant_vote.util.validation.ValidationUtil.assureIdConsistent;
import static ru.javaops.restaurant_vote.util.validation.ValidationUtil.checkNew;
