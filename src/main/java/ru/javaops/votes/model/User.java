...
import ru.javaops.votes.HasIdAndEmail;
import ru.javaops.votes.util.validation.NoHtml;

import java.util.*;

import static ru.javaops.votes.util.UsersUtil.DEFAULT_CALORIES_PER_DAY;
